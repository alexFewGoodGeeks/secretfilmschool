<section id="faq" class="faq-wrapper">
    <div class="container faq-content">
        <h2>FAQ</h2>
        <p>
            <strong class="uppercase">How long does the program take to complete?</strong> The whole course is packaged into less than five hours of
            video training.
        </p>
        <p>
        ...
        <p>You see, it’s not who you know that determines your chances of success anymore - its now <span style="font-style: italic; text-decoration: underline">what</span> you know that counts most, as well as getting the right help from someone who has already worked out how to achieve it.</p>
        <p>By singlehandely taking his first indie feature film to global audiences, getting accepted into multiple film festivals and selling his title to an international film distribution company - with no prior knowledge or experience of how to do it - Secret Film School creator Simon Sharman achieved what over 90% of other first time filmmakers fail to do with their first film.</p>
        ...
        <p>The Secret Film School program is incredible value for money and will be the best investment you make in yourself and your career because it will pay for itself a hundred times over. You’ll see just how valuable the course is even before you get to the end of the program and you’ll be amazed at how simple it is to complete.</p>
